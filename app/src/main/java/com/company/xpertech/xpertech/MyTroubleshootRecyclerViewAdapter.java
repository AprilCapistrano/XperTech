...
import com.company.xpertech.xpertech.TroubleshootFragment.OnListFragmentInteractionListener;
...
public class MyTroubleshootRecyclerViewAdapter extends RecyclerView.Adapter<MyTroubleshootRecyclerViewAdapter.ViewHolder> {
    ...
    public MyTroubleshootRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
